...
const Input: React.FC<InputProps> = ({id, label, type, placeholder, disabled, required, register, errors}) => {
    return (
        <div className="w-full relative">
            ...
            className={`peer w-full p-4  pt-6 outline-none bg-white font-light border-2 rounded-md disabled:opacity-70 disabled:cursor-not-allowed  
